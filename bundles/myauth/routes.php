...
Route::get($login_route, function(){ return View::make('myauth::login')->with('title', 'Login'); });
...
Route::get($signup_route, function(){ return View::make('myauth::signup')->with('title', 'Register'); });
